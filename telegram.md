# Техническое задание на разработку Telegram бота hitvpnbot

## 1. Общее описание
Telegram бот hitvpnbot предназначен для управления VPN-сервисом, включая настройку устройств, управление подпиской и балансом.
...
- Рекомендация подписаться на канал @hitvpn_news
...
- При добавлении устройства:
  - Генерация уникальной ссылки формата hitvpn://[уникальный_токен]
...
- Генерация уникальной ссылки формата https://t.me/hitvpnbot?start=[user_id]
...
📌 Обязательно (!!) подпишитесь на наш канал @hitvpn_news!
...
**Инструкция для iOS:**
1. Установите приложение HitVPN из AppStore
2. Скопируйте ссылку настройки в буфер обмена. Настройки всегда доступны в разделе "Мои устройства".
3. Запустите приложение HitVPN, вставьте скопированную ссылку и разрешите приложению добавление конфигураций VPN.
4. Включите VPN.


**Инструкция для Windows:**
1. Скачайте и установите приложение HitVPN для Windows: [ссылка]
2. Скопируйте ссылку в буфер обмена. Ссылка для настройки VPN всегда доступна в разделе "Мои устройства".
3. Запустите приложение HitVPN и вставьте скопированную ссылку.
4. Включите VPN.
...
- Регулярные напоминания о подписке на канал @hitvpn_news
- Проверка подписки пользователя на канал
- Запрет на использование сервиса для скачивания торрентов
- Возможность обновления приложений (HitVPN для iPhone, HitRay для Android)